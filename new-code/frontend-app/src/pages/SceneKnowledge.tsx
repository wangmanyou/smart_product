...
import { Alert, Button, Card, DatePicker, Form, Image, Input, Modal, Popconfirm, Radio, Select, Space, Table, Tag, Tree, Typography, Upload, message } from 'antd';
            ...
            >
              {keywordSearchItemIds.length ? (
                <Form.Item name="keyword" label="关键词" className="scene-knowledge-keyword-filter">
                  <Input allowClear placeholder="搜索文本、标签、附件名称" />
                </Form.Item>
              ) : null}
